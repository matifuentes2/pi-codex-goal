...
- proactively protects long-running goals from context pressure: soft goal compaction starts at 65% usage, and 75% is treated as the hard hidden-continuation threshold
